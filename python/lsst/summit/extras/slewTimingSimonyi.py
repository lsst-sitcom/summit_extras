...
COMMANDS_TO_QUERY = [
    ...
    "lsst.sal.CCCamera.logevent_startIntegration",
    "lsst.sal.CCCamera.logevent_startLoadFilter",
    "lsst.sal.CCCamera.logevent_startReadout",
    "lsst.sal.CCCamera.logevent_startRotateCarousel",
    "lsst.sal.CCCamera.logevent_startSetFilter",
    "lsst.sal.CCCamera.logevent_startShutterClose",
    "lsst.sal.CCCamera.logevent_startShutterOpen",
    "lsst.sal.CCCamera.logevent_startUnloadFilter",
    "lsst.sal.CCCamera.logevent_endLoadFilter",
    "lsst.sal.CCCamera.logevent_endOfImageTelemetry",
    "lsst.sal.CCCamera.logevent_endReadout",
    "lsst.sal.CCCamera.logevent_endRotateCarousel",
    "lsst.sal.CCCamera.logevent_endSetFilter",
    "lsst.sal.CCCamera.logevent_endShutterClose",
    "lsst.sal.CCCamera.logevent_endShutterOpen",
    "lsst.sal.CCCamera.logevent_endUnloadFilter",
    # MTAos
